...
class CitiesILI(BaseDataset):
    def __init__(self, *args, **kwargs):
        ...
        self.save_path = os.path.join("datasets", "CitiesILI")
        self.path_raw = os.path.join("datasets", "CitiesILI", "raw")
        self.path_temp = os.path.join("datasets", "CitiesILI", "temp")
    ...
    def download(self):
        ...
        df = df.select(pl.exclude("weeknum", "season", "weekyear"))
