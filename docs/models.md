...
| TiDE | MLP | Multivariate | TMLR | 2023 | Long-term Forecasting with TiDE: Time-series Dense Encoder | [Arxiv](https://arxiv.org/abs/2304.08424) - [REF](https://github.com/thuml/Time-Series-Library/blob/main/models/TiDE.py) |
| NonstationaryTransformer | Transformer | Multivariate | NeurIPS | 2022 | Non-stationary Transformers: Exploring the Stationarity in Time Series Forecasting | [Arxiv](https://arxiv.org/abs/2205.14415) - [REF](https://github.com/thuml/Time-Series-Library/blob/main/models/Nonstationary_Transformer.py) |
| MICN | CNN | Multivariate | ICLR | 2023 | MICN: Multi-scale Isometric Convolution Network for Long-term Time Series Forecasting | [OpenReview](https://openreview.net/forum?id=zt53IDUR1U) - [REF](https://github.com/thuml/Time-Series-Library/blob/main/models/MICN.py) |
| Koopa | MLP | Multivariate | NeurIPS | 2023 | Koopa: Learning Non-stationary Time Series with Koopman Predictors | [Arxiv](https://arxiv.org/abs/2305.18803) - [REF](https://github.com/thuml/Time-Series-Library/blob/main/models/Koopa.py) |
| ETSformer | Transformer | Multivariate | ICLR | 2022 | ETSformer: Exponential Smoothing Transformers for Time-series Forecasting | [Arxiv](https://arxiv.org/abs/2202.01381) - [REF](https://github.com/thuml/Time-Series-Library/blob/main/models/ETSformer.py) |
| MSGNet | GNN | Multivariate | AAAI | 2024 | MSGNet: Learning Multi-Scale Inter-Series Correlations for Multivariate Time Series Forecasting | [Arxiv](https://arxiv.org/abs/2401.00423) - [REF](https://github.com/thuml/Time-Series-Library/blob/main/models/MSGNet.py) |
| WPMixer | Wavelet | Multivariate || 2025 | WPMixer: Wavelet Packet Mixer for Time Series Forecasting | [Arxiv](https://arxiv.org/abs/2603.10095) - [REF](https://github.com/Secure-and-Intelligent-Systems-Lab/WPMixer) |
| TimeFilter | GNN | Multivariate | AAAI | 2025 | TimeFilter: Scalable and Adaptive Graph Neural Network for Time Series Forecasting | [Arxiv](https://arxiv.org/abs/2412.16522) - [REF](https://github.com/thuml/Time-Series-Library/blob/main/models/TimeFilter.py) |
| MultiPatchFormer | Transformer | Multivariate || 2024 | MultiPatchFormer: Multi-scale Patch Transformer for Long-term Time Series Forecasting | [Arxiv](https://arxiv.org/abs/2402.04048) - [REF](https://github.com/thuml/Time-Series-Library/blob/main/models/MultiPatchFormer.py) |
| Reformer | Transformer | Multivariate | ICLR | 2020 | Reformer: The Efficient Transformer | [OpenReview](https://openreview.net/forum?id=rkgNKkHtvB) - [REF](https://github.com/thuml/Time-Series-Library/blob/main/models/Reformer.py) |
