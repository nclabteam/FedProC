...
class ModernTCN(nn.Module):
    ...
    def __init__(self, configs):
        ...
        self.nvars = configs.input_channels
        ...
        self.freq = configs.granularity_unit
        self.seq_len = configs.input_len
        self.c_in = (self.nvars,)
        self.individual = False
        self.target_window = configs.output_len
        ...
        if self.decomposition:
            self.decomp_module = SeriesDecompMA(self.kernel_size)
